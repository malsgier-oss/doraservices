              ...
              <div className="text-center py-10">
                ...
                {list.map((s) => {
                  ...
                  return (
                    <button
                      key={s.id}
                        className={`${HUB_CARD_BASE} bg-card min-h-[96px] p-4 flex items-center gap-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 active:scale-[0.99] touch-manipulation no-tap-highlight`}
